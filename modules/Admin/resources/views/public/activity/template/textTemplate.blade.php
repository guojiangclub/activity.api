<div class="row padding-top-7 items_control">
    <label class="col-md-2 control-label input-title" @if(!in_array($field['name'], ['province', 'id_card', 'user_name', 'mobile', 'other_certificate'])) data-toggle="modal" data-target="#input_{{$field['index']}}_modal" @endif><span class="input_{{$field['index']}}_title" title="点击修改">{{$field['title']}}</span>：</label>
    ...
    <div class="modal fade" id="input_{{$field['index']}}_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control input_{{$field['index']}}_title" value="{{$field['title']}}" placeholder="文本框" oninput="updateTitle('input_{{$field['index']}}_title', this)" @if(in_array($field['name'], ['province', 'id_card', 'user_name', 'mobile', 'other_certificate'])) readonly @endif>
                        </div>
                    </div>
                </div>
