        ...
        <div class="tab-content">
            <div id="tab-1" class="tab-pane active">
                <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a id="recordBatchExport" href="javascript:;">批量导出</a></li>
                                </ul>
                            </div>
                            <div class="btn-group">
                                <button class="ladda-button btn btn-primary"  id="coupons_use_export" data-style="slide-right">导出</button>
                            </div>
                            <div class="btn-group">
                    ...
                    {!! Form::open( [ 'route' => ['admin.promotion.useRecord'], 'method' => 'get', 'id' => 'recordSearch-form','class'=>'form-horizontal'] ) !!}
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="col-sm-6">
