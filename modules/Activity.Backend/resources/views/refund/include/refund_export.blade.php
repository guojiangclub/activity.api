<div class="form-group">
    <label class="control-label col-md-2">申请状态：</label>
    <div class="col-md-10">
    ...
    <div class="col-md-10">
        ...
        <div class="col-sm-6">
            <div class="input-group date form_datetime">
                                        <span class="input-group-addon" style="cursor: pointer">
                                            <i class="fa fa-calendar"></i></span>
                <input type="text" class="form-control" name="c_etime" value="{{\Carbon\Carbon::now()}}" placeholder="截止" readonly>
                <span class="add-on"><i class="icon-th"></i></span>
            </div>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6 col-md-offset-4">
        <a id="refunds_xls" class="btn btn-primary" href="javascript:void(0)">导出</a>
    </div>
</div>
